...
/* Deferred-frontier top-k scratch width: the wire's top_logits gate asks
 * for 8, and the scratch tensors are sized once at session open.  Lives in
 * this header so both ds4.c and the graph body see it before first use. */
#define DS4_QWEN4EXP_TOPK_MAX 8u
