 ...
 *
 * Depth 22 over a 16384-row exact shortlist.  Two measured points bracket this:
 ...
 * 337.7 + 44.6 = 382.3 MB; this is 185.7 + 89.1 = 274.8 MB, i.e. -107.5 MB.
 *
 ...
 * of their scores.  20, 22 and 24 all take exactly one inner-loop pass, since a row
...
static constexpr uint32_t MTP_TARGET_NATIVE_SCREEN_GROUPS = 22u;
