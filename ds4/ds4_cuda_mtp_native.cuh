/* submission 2026-09-23T00:10Z (account newjordan): dense coarse-screen tape on the promoted public original. */
 * on the routed-MoE-down activation reads + a page hint over the PLE gather's row set. No behaviour
 * changes beyond those three mechanisms. */
