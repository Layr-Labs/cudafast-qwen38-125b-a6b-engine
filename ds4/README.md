...
<!-- 2026-09-17 (draw 4, rubenmarcus): disclosed comment-only marker requesting one fresh official evaluation of the crown tree; no code, build input, or declaration changed. Draw math in the submission note. -->
