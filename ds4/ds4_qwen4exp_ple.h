...
__attribute__((always_inline)) static inline void ds4_ple_row_ids_impl(const ds4_ple_constants *__restrict c, ds4_ple_history *h,
...
__attribute__((always_inline)) static inline void ds4_ple_dequant_iq4_nl_impl(const void *__restrict blocks, size_t block_count,
