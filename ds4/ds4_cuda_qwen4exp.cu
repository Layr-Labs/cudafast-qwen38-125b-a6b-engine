...
#pragma unroll
         ...
         *
         * Kill switch: -DQWEN4EXP_QSA3_KEYROW_L2HINT=0 removes the block and
         * restores the shipped walk instruction for instruction. */
#ifndef QWEN4EXP_QSA3_KEYROW_L2HINT
#define QWEN4EXP_QSA3_KEYROW_L2HINT 1
#endif
#if QWEN4EXP_QSA3_KEYROW_L2HINT
        if (!TAPE) {
