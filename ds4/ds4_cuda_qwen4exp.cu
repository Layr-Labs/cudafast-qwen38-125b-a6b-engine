 ...
 * DIST ladder: 4 measured 2.7621 (neutral-to-negative, likely L2
 * pollution on route divergence); 2 pending in parallel. DIST3 splits
 * the difference with one extra covered step over DIST2. */
