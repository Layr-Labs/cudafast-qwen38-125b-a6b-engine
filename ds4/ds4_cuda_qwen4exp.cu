...
/* REDRAW OF THE FRONTIER, AND THE CALIBRATION DATASET AT N = 11.
   ...
   n = 11.  Composite mean 2.663430, coefficient of variation 1.135 percent,
   observed range 3.689 percent of the minimum.  Decode CV 0.746 percent,
   prefill CV 2.574 percent.
