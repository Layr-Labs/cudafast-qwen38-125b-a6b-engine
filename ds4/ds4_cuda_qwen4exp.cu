...
#ifndef QW_GU_SPLIT_PANEL_ASYNC_COPY
#define QW_GU_SPLIT_PANEL_ASYNC_COPY 1
#endif
...
qwen4exp_moe_gateup_split_kernel(
    ...
    if (Coop) {
...
#if QW_GU_SPLIT_PANEL_ASYNC_COPY
         ...
         * already run.
         *
         * -DQW_GU_SPLIT_PANEL_ASYNC_COPY=0 restores the shipped register-staged fill
         * byte for byte. */
