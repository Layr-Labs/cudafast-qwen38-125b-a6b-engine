...
extern "C" const char *ds4_gpu_qwen4exp_kernel_limits(void) {
    ...
    snprintf(buf, sizeof(buf),
             "hd[sc=%d lo=%d dn=%d v=%d os=%d ol=%d r=%d] "
