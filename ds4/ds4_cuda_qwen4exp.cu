...
/* REDRAW OF THE FRONTIER, AND THE CALIBRATION DATASET AT N = 9.
   ...
   n = 9.  Composite mean 2.658372, coefficient of variation 1.173 percent,
   observed range 3.689 percent of the minimum.  Decode CV 0.781 percent,
   prefill CV 2.508 percent.
