 ...
 */
/* This build's note auto09180246_135 records that two kernels with
 * identical grids can still fail to fuse profitably: the fused body takes
 * the higher register count of the two, and a hundred and thirty-six
 * registers across two hundred and fifty-six threads exceeds half the
 * register file, which turns one wave into two.
 */
