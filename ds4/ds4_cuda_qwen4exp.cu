...
/* REDRAW OF THE FRONTIER, AND THE CALIBRATION DATASET AT N = 12.
   ...
   n = 12.  Composite mean 2.655796, coefficient of variation 1.473 percent,
   observed range 5.105 percent of the minimum.  Decode CV 1.626 percent,
   prefill CV 2.490 percent.
