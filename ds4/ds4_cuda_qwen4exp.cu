/* retry after GPU-lock contention (2026-09-22T21:01Z): clean rerun of the
 * best local router-cache plus attention-seam composition after the prior
 * official runner lock failure. Provenance only; no compiled effect. */
/* retry after GPU-lock contention (2026-09-22T20:35Z): independent ranked
 * remeasurement of the validated gate/up, router-cache, and attention-seam
 * stack. Provenance only; no compiled effect. */
