...
extern int ds4_gpu_mtp_native_screen_policy(ds4_gpu_tensor *, ds4_gpu_tensor *,
    ds4_gpu_tensor *, ds4_gpu_tensor *, const void *, uint64_t, uint64_t,
    uint32_t, uint32_t, uint32_t, uint32_t, const ds4_gpu_tensor *,
    float, float) __attribute__((weak));
...
void ds4_qwen4exp_mtp_default_hooks(ds4_qwen4exp_mtp_gpu_hooks *hooks) {
    ...
    hooks->native_screen_policy = ds4_gpu_mtp_native_screen_policy;
#else
    hooks->ehx_pack    = NULL;
    hooks->native_init = NULL;
    hooks->native_screen = NULL;
    hooks->native_map = NULL;
    hooks->native_screen_policy = NULL;
#endif
