...
extern int ds4_gpu_mtp_native_screen_deferred(ds4_gpu_tensor *, ds4_gpu_tensor *, ds4_gpu_tensor *,
    const void *, uint64_t, uint64_t, uint32_t, uint32_t, uint32_t, uint32_t,
    const ds4_gpu_tensor *) __attribute__((weak));
extern int ds4_gpu_mtp_native_map_deferred(ds4_gpu_tensor *, const ds4_gpu_tensor *,
...
void ds4_qwen4exp_mtp_default_hooks(ds4_qwen4exp_mtp_gpu_hooks *hooks) {
    ...
    hooks->native_screen_deferred = ds4_gpu_mtp_native_screen_deferred;
    hooks->native_map_deferred = ds4_gpu_mtp_native_map_deferred;
#else
    hooks->ehx_pack    = NULL;
    hooks->native_init = NULL;
    hooks->native_screen = NULL;
    hooks->native_map = NULL;
    hooks->native_screen_deferred = NULL;
    hooks->native_map_deferred = NULL;
#endif
