...
static void finish(){
 ...
 if(scenario=="noisy")cost=elapsed_count/2%7==6?7:9;
...
int main(int argc,char **argv){
 ...
 if(success){
  ...
  assert(mtp_partial_prefer==(scenario=="fast"));assert(order.size()==470);
...
'''
cases=['fast','marginal','slower','one_slow','noisy','five_wins','disabled','no_partial',
