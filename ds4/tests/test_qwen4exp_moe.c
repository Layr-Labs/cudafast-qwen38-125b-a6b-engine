...
static void run_split_vector_case(
    ...
    /* The used counts cover all four possible word-aligned prefix residues
     * before xq; the output stride remains the larger allocated capacity. */
    ...
    printf("  split activation vectors %s: %u complete eager, %u graph comparisons "
