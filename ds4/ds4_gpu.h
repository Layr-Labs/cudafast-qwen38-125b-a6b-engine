...
int ds4_gpu_mtp_native_screen_r2_init(uint32_t width, uint64_t *bytes,
    uint32_t *capacity);
int ds4_gpu_mtp_native_top1_r2(ds4_gpu_tensor *winner,
    ds4_gpu_tensor *scratch, const void *map, uint64_t bytes, uint64_t offset,
    uint32_t dim, uint32_t vocab, const ds4_gpu_tensor *x);
int ds4_gpu_mtp_native_screen(ds4_gpu_tensor *out, ds4_gpu_tensor *ids,
    ...
    const ds4_gpu_tensor *x);
int ds4_gpu_mtp_native_screen_r2(ds4_gpu_tensor *out, ds4_gpu_tensor *ids,
    ds4_gpu_tensor *scratch, const void *map, uint64_t bytes, uint64_t offset,
    uint32_t dim, uint32_t vocab, uint32_t prefix, uint32_t tail,
    const ds4_gpu_tensor *x);
...
int ds4_gpu_mtp_native_map_r2(ds4_gpu_tensor *winner,
