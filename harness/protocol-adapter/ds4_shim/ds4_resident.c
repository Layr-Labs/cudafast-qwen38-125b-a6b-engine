...
int main(void) {
     ...
     * on private synthetic keys, once HERE after head scratch preparation and
     * before the socket binds. No request or model forward is evaluated.
     * On device-query failure the string is empty and the identity is exactly
